    ...
    namespace Utils
    {
        ...
        public:
            ...
            int_type overflow(int_type ch) override
            {
                ...
                BabylonAssert(bufferSize == static_cast<size_t>(pdelta));
                BabylonAssert(bufferSize >= static_cast<size_t>(gdelta));
            ...
            {
                BabylonAssert(gptr() == egptr());
                BabylonAssert(pptr() >= egptr());
