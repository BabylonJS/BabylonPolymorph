...
Babylon Canvas code should only include rapidjson using this header. \
...
#define RAPIDJSON_NAMESPACE Babylon::rapidjson
#define RAPIDJSON_NAMESPACE_BEGIN namespace Babylon { namespace rapidjson {
