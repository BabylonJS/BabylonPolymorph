...
namespace Babylon
{
    namespace Utils
    {
        ...
        namespace glTF
        {
            ...
            {
            public:
                // NOTE: Must be kept in sync with Babylon::Engine::AnimationManager::AnimationSupport (Animation/AnimationManager.h)
                ...
                // NOTE: Must be kept in sync with Babylon::Engine::AnimationManager::AnimationType (Animation/AnimationManager.h)
                ...
                static eSupport BABYLON_SDK_CALL GetSupport(const Microsoft::glTF::Document& gltfDocument, const Microsoft::glTF::Animation& animation);
                static eType BABYLON_SDK_CALL GetType(const Microsoft::glTF::Document& gltfDocument, const Microsoft::glTF::Animation& animation);
            ...
            void BABYLON_SDK_CALL OverrideLegacyGLTFMaterial(Microsoft::glTF::Material& material, LegacyMode mode = EngineLoader);
            ...
            std::set<std::string> BABYLON_SDK_CALL GetJoints(const Microsoft::glTF::Document& gltfDocument);
            ...
            Babylon::Utils::Math::Matrix GetTextureTransformMatrix(const Microsoft::glTF::KHR::TextureInfos::TextureTransform& textureTransform); bool TryGetTextureTransform(const Babylon::Utils::Math::Matrix& matrix, Microsoft::glTF::TextureInfo& textureInfo);
