...
namespace Babylon
{
    namespace Utils
    {
        ...
        bool BABYLON_SDK_CALL TelemetrySingleton::Initialize(ITelemetryManager* instance)
        {
        ...
        bool TelemetryManager::RemoveHandler(TelemetryToken token)
        {
            ...
            BabylonAssertExpr((removeHandlersResult || removeHandlersExpandedResult) || (!removeHandlersResult && !removeHandlersExpandedResult), "TelemetryManager::RemoveHandler - token should not exist in both handler tables");
