...
using namespace Babylon::Utils::Tweening;

std::unique_ptr<ICurve> Babylon::Utils::Tweening::CurveFactory::GetCurve(CurveType type)
{
    switch (type)
    {
        ...
        default:
            throw BabylonException("Curve type is not supported");
    }
}
