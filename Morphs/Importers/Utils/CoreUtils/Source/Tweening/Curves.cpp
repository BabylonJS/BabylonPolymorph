...
double Babylon::Utils::Tweening::LinearCurve::Remap(double progress) const
{
...
//quadratic
double Babylon::Utils::Tweening::QuadraticEaseInCurve::Remap(double progress) const
{
...
double Babylon::Utils::Tweening::QuadraticEaseOutCurve::Remap(double progress) const
{
...
double Babylon::Utils::Tweening::QuadraticEaseInOutCurve::Remap(double progress) const
{
...
//cubic
double Babylon::Utils::Tweening::CubicEaseInCurve::Remap(double progress) const
{
...
double Babylon::Utils::Tweening::CubicEaseOutCurve::Remap(double progress) const
{
...
double Babylon::Utils::Tweening::CubicEaseInOutCurve::Remap(double progress) const
{
...
//quartic
double Babylon::Utils::Tweening::QuarticEaseInCurve::Remap(double progress) const
{
...
double Babylon::Utils::Tweening::QuarticEaseOutCurve::Remap(double progress) const
{
...
double Babylon::Utils::Tweening::QuarticEaseInOutCurve::Remap(double progress) const
{
...
double Babylon::Utils::Tweening::ExponentialEaseInCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::ExponentialEaseOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::ExponentialEaseInOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::SineEaseInCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::SineEaseOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::SineEaseInOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::BackEaseInCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::BackEaseOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::BackEaseInOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::BounceEaseInCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::BounceEaseOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::BounceEaseInOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::ElasticEaseInCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::ElasticEaseOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
...
double Babylon::Utils::Tweening::ElasticEaseInOutCurve::Remap(double progress) const
{
    //  Special case returning exactly "to" value if progress equals / greater than 1.0
    if (progress >= 1.0)
        return 1.0;
