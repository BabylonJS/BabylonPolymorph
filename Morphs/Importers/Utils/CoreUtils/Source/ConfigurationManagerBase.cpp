...
namespace Babylon
{
    namespace Utils
    {
        ...
        ConfigurationDomain IConfigurationManager::GetDomain(ConfigurationPropertyName_ propertyName) const
        {
            ...
            {
                throw BabylonInvalidArgException("IConfigurationManager::GetDomain() -- empty string is not a valid property name");
            }
            ...
            if (propertyName[0] == '/')
            {
                ...
                {
                    throw BabylonInvalidArgException("IConfigurationManager::GetDomain() -- property domain must begin and end with a slash, e.g. /CustomDomain/Category.Value");
                }
