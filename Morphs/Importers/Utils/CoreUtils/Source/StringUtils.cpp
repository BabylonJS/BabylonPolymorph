...
namespace Details
{
    ...
    {
        auto vals = Babylon::Utils::Split(string, what);
    ...
    std::basic_string<TChar> GetPathFileExtensionLower(std::basic_string<TChar> const& path)
    {
        ...
        Babylon::Utils::TransformToLower(extension);
        return extension;
    }
...
std::wstring Babylon::Utils::StringToWString(const char* s, size_t size)
{
    if (size == 0)
    {
        return std::wstring();
...
std::string Babylon::Utils::WStringToString(const wchar_t* w, size_t size)
{
    if (size == 0)
    {
        return std::string();
...
std::wstring Babylon::Utils::StringToWString(const std::string& s)
{
    return StringToWString(s.data(), s.size());
}

std::string Babylon::Utils::WStringToString(const std::wstring& w)
{
    return WStringToString(w.data(), w.size());
}

std::string Babylon::Utils::LTrim(std::string str)
{
    return Details::LTrim(std::move(str));
}

std::wstring Babylon::Utils::LTrim(std::wstring str)
{
    return Details::LTrim(std::move(str));
}

std::string Babylon::Utils::RTrim(std::string str)
{
    return Details::RTrim(std::move(str));
}

std::wstring Babylon::Utils::RTrim(std::wstring str)
{
    return Details::RTrim(std::move(str));
}

std::string Babylon::Utils::Trim(std::string str)
{
    return Details::Trim(std::move(str));
}

std::wstring Babylon::Utils::Trim(std::wstring str)
{
    return Details::Trim(std::move(str));
}

std::vector<std::string> Babylon::Utils::Split(const std::string& string, const std::string& delimiter)
{
    return Details::Split(string, delimiter);
}

std::vector<std::wstring> Babylon::Utils::Split(const std::wstring& string, const std::wstring& delimiter)
{
    return Details::Split(string, delimiter);
}

std::vector<std::string> Babylon::Utils::SplitRegex(const std::string& string, const std::string& regex)
{
    return Details::SplitRegex(string, regex);
}

std::vector<std::wstring> Babylon::Utils::SplitRegex(const std::wstring& string, const std::wstring& regex)
{
    return Details::SplitRegex(string, regex);
}

std::string Babylon::Utils::StringReplace(std::string const& string, std::string const& what, std::string const& with)
{
    return Details::StringReplace(string, what, with);
}

std::wstring Babylon::Utils::StringReplace(std::wstring const& string, std::wstring const& what, std::wstring const& with)
{
    return Details::StringReplace(string, what, with);
}

std::string Babylon::Utils::GetPathConsistentSlashes(std::string const& path)
{
    // TODO: Use a regexp, in cases where we have many many consecutive slashes.
    auto tmp = path;
    tmp = Babylon::Utils::StringReplace(tmp, "\\", "/");
    tmp = Babylon::Utils::StringReplace(tmp, "//", "/");
    return tmp;
}

std::wstring Babylon::Utils::GetPathConsistentSlashes(std::wstring const& path)
{
    // TODO: Use a regexp, in cases where we have many many consecutive slashes.
    auto tmp = path;
    tmp = Babylon::Utils::StringReplace(tmp, L"\\", L"/");
    tmp = Babylon::Utils::StringReplace(tmp, L"//", L"/");
    return tmp;
}

std::string Babylon::Utils::GetPathConcatenation(std::string const& first, std::string const& second)
{
    return first + '/' + second;
}

std::wstring Babylon::Utils::GetPathConcatenation(std::wstring const& first, std::wstring const& second)
{
    return first + L'/' + second;
}

bool Babylon::Utils::IsPathAbsolute(const std::string& path)
{
    return Details::IsPathAbsolute(path);
}

bool Babylon::Utils::IsPathAbsolute(const std::wstring& path)
{
    return Details::IsPathAbsolute(path);
}

bool Babylon::Utils::IsPathRelative(const std::string& path)
{
    return !Details::IsPathAbsolute(path);
}

bool Babylon::Utils::IsPathRelative(const std::wstring& path)
{
    return !Details::IsPathAbsolute(path);
}

std::string Babylon::Utils::GetPathDirectory(std::string const& path)
{
    return Details::GetPathDirectory(path);
}

std::wstring Babylon::Utils::GetPathDirectory(std::wstring const& path)
{
    return Details::GetPathDirectory(path);
}

std::string Babylon::Utils::GetPathFileName(std::string const& path)
{
    return Details::GetPathFileName(path);
}

std::wstring Babylon::Utils::GetPathFileName(std::wstring const& path)
{
    return Details::GetPathFileName(path);
}

std::string Babylon::Utils::GetPathFileExtension(std::string const& path)
{
    return Details::GetPathFileExtension(path);
}

std::wstring Babylon::Utils::GetPathFileExtension(std::wstring const& path)
{
    return Details::GetPathFileExtension(path);
}

std::string Babylon::Utils::GetPathFileExtensionLower(std::string const& path)
{
    return Details::GetPathFileExtensionLower(path);
}

std::wstring Babylon::Utils::GetPathFileExtensionLower(std::wstring const& path)
{
    return Details::GetPathFileExtension(path);
}

bool Babylon::Utils::BeginsWith(std::string const &a, char b)
{
    return Details::BeginsWith(a, b);
}

bool Babylon::Utils::BeginsWith(std::string const &a, std::string const &b)
{
    return Details::BeginsWith(a, b);
}

bool Babylon::Utils::BeginsWith(std::wstring const &a, wchar_t b)
{
    return Details::BeginsWith(a, b);
}

bool Babylon::Utils::BeginsWith(std::wstring const &a, std::wstring const &b)
{
    return Details::BeginsWith(a, b);
}

bool Babylon::Utils::EndsWith(std::string const &a, char b)
{
    return Details::EndsWith(a, b);
}

bool Babylon::Utils::EndsWith(std::string const &a, std::string const &b)
{
    return Details::EndsWith(a, b);
}

bool Babylon::Utils::EndsWith(std::wstring const &a, wchar_t b)
{
    return Details::EndsWith(a, b);
}

bool Babylon::Utils::EndsWith(std::wstring const &a, std::wstring const &b)
{
    return Details::EndsWith(a, b);
}

void Babylon::Utils::TransformToLower(std::string& str)
{
    return Details::TransformToLower(str);
}

void Babylon::Utils::TransformToLower(std::wstring& str)
{
    return Details::TransformToLower(str);
}

std::string Babylon::Utils::ToLower(const std::string& str)
{
    return Details::ToLower(str);
}

std::wstring Babylon::Utils::ToLower(const std::wstring& str)
{
    return Details::ToLower(str);
}
...
int Babylon::Utils::BabylonVSNPrintf_s(char* const _Buffer, size_t const _BufferCount, size_t const _MaxCount, char const* const _Format, va_list _ArgList)
{
