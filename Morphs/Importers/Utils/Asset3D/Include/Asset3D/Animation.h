...
namespace Babylon
{
    namespace Transcoder
    {
        namespace Animation
        {
            ...
            struct Joint
            {
                using Matrix = Babylon::Utils::Math::Matrix;
            ...
            struct MotionState
            {
                ...
                MotionState(const Babylon::Utils::Math::Vector3& t,
                    const Babylon::Utils::Math::Quaternion& r,
                    const Babylon::Utils::Math::Vector3& s)
                    :trans(t), rot(r), scale(s) {}
                Babylon::Utils::Math::Vector3       trans;
                Babylon::Utils::Math::Quaternion    rot;
            ...
            public:
                ...
                bool BABYLON_SDK_CALL IsSupported() const { return m_metadataFlags.Test(eMetadataFlags::kSkeletonAnimationLoaded); }
                bool BABYLON_SDK_CALL IsMissingData() const { return m_metadataFlags.Test(eMetadataFlags::kMorphAnimationFound) ||
