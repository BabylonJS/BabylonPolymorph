...
namespace Babylon
{
    namespace Transcoder
    {
        ...
        public:
            ...
            virtual BoundingBox CalcTopDownBounds(const Babylon::Utils::Math::Matrix& transform) const;
            ...
            void SetPositions(std::vector<Babylon::Utils::Math::Vector3> positions) { m_positions = std::move(positions); }
            void SetNormals(std::vector<Babylon::Utils::Math::Vector3> normals) { m_normals = std::move(normals); }
            void SetUv0s(std::vector<Babylon::Utils::Math::Vector2> uv0s) { m_uv0s = std::move(uv0s); }
            void SetUv1s(std::vector<Babylon::Utils::Math::Vector2> uv1s) { m_uv1s = std::move(uv1s); }
            void SetTangents(std::vector<Babylon::Utils::Math::Vector4> tangents) { m_tangents = std::move(tangents); }
            ...
            void AddPosition(const Babylon::Utils::Math::Vector3& position) { m_positions.push_back(position); }
            void AddNormal(const Babylon::Utils::Math::Vector3& normal) { m_normals.push_back(normal); }
            void AddUv0(const Babylon::Utils::Math::Vector2& uv0) { m_uv0s.push_back(uv0); }
            void AddUv1(const Babylon::Utils::Math::Vector2& uv1) { m_uv1s.push_back(uv1); }
            void AddTangent(const Babylon::Utils::Math::Vector4& tangent) { m_tangents.push_back(tangent); }
            ...
            const std::vector<Babylon::Utils::Math::Vector3>& GetPositions() const { return m_positions; }
            const std::vector<Babylon::Utils::Math::Vector3>& GetNormals() const { return m_normals; }
            const std::vector<Babylon::Utils::Math::Vector2>& GetUv0s() const { return m_uv0s; }
            const std::vector<Babylon::Utils::Math::Vector2>& GetUv1s() const { return m_uv1s; }
            const std::vector<Babylon::Utils::Math::Vector4>& GetTangents() const { return m_tangents; }
        ...
        private:
            ...
            std::vector<Babylon::Utils::Math::Vector2> m_uv0s;
            std::vector<Babylon::Utils::Math::Vector2> m_uv1s;
