...
TRACELOGGING_DEFINE_PROVIDER(
    g_BabylonLoggingTelemetryProvider,
    "Microsoft.Babylon.Core.Canvas",
    ...
    , m_tag("CanvasDefault")
{
    ...
    {
        TraceLoggingRegister(g_BabylonLoggingTelemetryProvider);
    }
...
TelemetryTraceLoggerWin::~TelemetryTraceLoggerWin()
{
    if (--s_registrationCount == 0)
    {
        TraceLoggingUnregister(g_BabylonLoggingTelemetryProvider);
    }
}
