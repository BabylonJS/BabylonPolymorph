...
namespace Babylon
{
    namespace Framework
    {
        namespace V1
        {
            ...
            class BABYLON_SDK_API SceneWriter : public ISceneWriter, public CommonFrameWriter
            {
            private:
            ...
            void SceneWriter::AddScene(const SceneDefinition& sceneDefinition)
            {
                ...
                {
                    throw Utils::BabylonFailException("SceneWriter::AddScene: too many items added");
                }
                ...
                const LightDefinition& lightDefinition)
            {
                ...
                {
                    throw Utils::BabylonFailException("SceneWriter::AddLight: You must call BeginFrame() before AddLight()");
                }
                ...
                if (m_numItems > m_expectedItemCount)
                {
                    throw Utils::BabylonFailException("SceneWriter::AddLight: too many items added");
                }
                ...
                const CameraDefinition& cameraDefinition)
            {
                if (m_outputBuffer == nullptr)
                {
                    throw Utils::BabylonFailException("SceneWriter::AddCamera: You must call BeginFrame() before AddCamera()");
                }
                ...
                if (m_numItems > m_expectedItemCount)
                {
                    throw Utils::BabylonFailException("SceneWriter::AddCamera: too many items added");
                }
