...
public:
    ...
    static PerformanceLoggerPtr BABYLON_SDK_CALL CreateWithDefaultProviders();
...
template <typename T>
double Babylon::Utils::PerformanceLogger::GetMeasurementTraceValue(T measurementValue)
{
...
template<typename T>
void Babylon::Utils::PerformanceLogger::AddMeasurement(
    const char* file,
    int line,
    const char* function,
    const char* measurementName,
...
inline TimePoint Babylon::Utils::PerformanceLogger::GetCurrentTime()
{
...
#define TRACE_SCOPE(logger, arg1)  Babylon::Utils::PerformanceScope MAKE_UNIQUE(_scope_)(logger, __FILE__, __LINE__, __func__, arg1)
#define TRACE_SCOPE_SINGLE_EVENT(logger, arg1)  Babylon::Utils::PerformanceScope MAKE_UNIQUE(_scope_)(logger, __FILE__, __LINE__, __func__, arg1, true)
#define TRACE_FREQ(logger, arg1) logger->AddMark(Babylon::Utils::PerformanceLogger::DefaultMark, __FILE__, __LINE__, __func__, arg1);
