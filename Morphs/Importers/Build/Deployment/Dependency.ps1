...
$thisProjectOutDir = [string]"$babylonRoot\Built\Out\$compiler\$platform\$configuration\$projectName\"
...
$projectsToCopy.Split(";") | ForEach {
    ...
    $directoryToCopy = [string]"$babylonRoot\Built\Out\$itemCompiler\$platform\$configuration\$itemProject\"
