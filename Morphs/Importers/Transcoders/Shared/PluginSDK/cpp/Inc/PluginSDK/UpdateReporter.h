...
inline Spectre::Transcoder::UpdateReporter::UpdateReporter(
    float parsingWeight,
    ...
    m_percentageReporter(nullptr)
{
    ...
    {
        throw Spectre::Utils::SpectreException("The weights must sum up to 1.");
    }
}

inline void Spectre::Transcoder::UpdateReporter::ReportCompletedParsing(float percentage)
{
    m_parsingPercentage = percentage;
    ReportProgress();
}

inline void Spectre::Transcoder::UpdateReporter::ReportCompletedEncoding(float percentage)
{
    m_encodingPercentage = percentage;
    ReportProgress();
}

inline void Spectre::Transcoder::UpdateReporter::ReportAdditionalCompletedParsing(float percentage)
{
    m_parsingPercentage += percentage;
    ReportProgress();
}

inline void Spectre::Transcoder::UpdateReporter::ReportAdditionalCompletedEncoding(float percentage)
{
    m_encodingPercentage += percentage;
    ReportProgress();
}

inline void Spectre::Transcoder::UpdateReporter::SetWeights(float parsingWeight, float encodingWeight)
{
    if (parsingWeight + encodingWeight != 1.f)
    {
        throw Spectre::Utils::SpectreException("The weights must sum up to 1.");
...
inline void Spectre::Transcoder::UpdateReporter::SetProgressReporter(ProgressIndicatorReporter percentageReporter)
{
    m_percentageReporter = percentageReporter;
}

inline void Spectre::Transcoder::UpdateReporter::ReportProgress()
{
