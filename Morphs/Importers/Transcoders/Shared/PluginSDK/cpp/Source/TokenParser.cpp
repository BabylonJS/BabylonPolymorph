...
bool TokenParser::GetBoolAtPosition(LineTokensPtr const& tokens, size_t position)
{
    ...
    Spectre::Utils::TransformToLower(value);
    ...
    throw Spectre::Utils::SpectreException("The boolean token was not recognised");
}
...
void TokenParser::AssertTokensNumber(LineTokensPtr const& tokens, size_t expectedNumberOfTokens)
{
    ...
    throw Spectre::Utils::SpectreException("The number of tokens is smaller than the expected.");
}
