...
void ExportTextures(ExporterTexture::TextureType typedToExport, std::shared_ptr<Asset3D> asset3D, std::string const& assetName, IOutputStreamFactory* streamFactory, Spectre::Framework::ICancellationTokenPtr cancellationToken)
{
    SpectreUnusedParameter(assetName);
...
void ExporterTexture::ExportStaticPNG( Asset3DPtr asset3D, std::string const& assetName, IOutputStreamFactory* streamFactory, FractionalProgressCallback progress, Spectre::Framework::ICancellationTokenPtr cancellationToken, const std::unordered_map<std::string, std::string>& options)
{
...
void ExporterTexture::ExportStaticJPG( Asset3DPtr asset3D, std::string const& assetName, IOutputStreamFactory* streamFactory, FractionalProgressCallback progress, Spectre::Framework::ICancellationTokenPtr cancellationToken, const std::unordered_map<std::string, std::string>& options)
{
    TranscodeOptions transcodeOptions;
    transcodeOptions.Parse(options);
...
void ExporterTexture::ExportTexture(const TextureDescriptor& texture, const LayerType layer)
{
    ...
    {
        throw Utils::SpectreException("Unsupported format");
    }
}