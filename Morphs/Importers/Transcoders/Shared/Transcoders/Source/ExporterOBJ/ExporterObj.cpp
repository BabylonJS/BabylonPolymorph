...
void ExporterObj::ExportStatic(Asset3DPtr asset3D, const std::string& assetName, IOutputStreamFactory* streamFactory, FractionalProgressCallback progress, Babylon::Framework::ICancellationTokenPtr cancellationToken, const std::unordered_map<std::string, std::string>& options)
{
    ...
    {
        throw Utils::BabylonException("Asset3D contains non-triangle geometry.");
    }
...
ExporterObj::ExporterObj(std::string assetName, IOutputStreamFactory* streamFactory, Babylon::Framework::ICancellationTokenPtr cancellationToken) :
...
{
    // TODO: TEMP COMMENT
    *m_geometryStream << "# Exported by Babylon Exporter"; // << Babylon_PACKAGE_VERSION << "\n";
...
void Babylon::Transcoder::ExporterObj::WriteVertex(const Geometry& geometry, size_t index)
{
...
void Babylon::Transcoder::ExporterObj::ExportLeaf(MaterialDescriptor& material)
{
...
std::string Babylon::Transcoder::ExporterObj::ExportTexture(TextureDescriptor& texture)
{
...
std::string Babylon::Transcoder::ExporterObj::GetUniqueName(const ITraversableWithName& element)
{
