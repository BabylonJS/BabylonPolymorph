...
using namespace Spectre::rapidjson;
...
StlFileType Spectre::Transcoder::GetStlFileType(std::shared_ptr<std::istream> stream)
{
    ...
    {
        throw Spectre::Utils::SpectreException("Invalid Length");
    }
...
std::shared_ptr<Asset3D> Spectre::Transcoder::ImportSTL(
    ...
    uint64_t* streamSize)
{
    ...
    case StlFileType::Unknown:
        throw Spectre::Utils::SpectreNotImplException("Unsupported STL file type detected", false);
    default:
        throw Spectre::Utils::SpectreNotImplException("Unsupported for this STL file type not implemented", false);
    }
