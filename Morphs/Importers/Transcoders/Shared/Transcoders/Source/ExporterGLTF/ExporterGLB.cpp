...
void ExporterGLB::ExportStatic(Asset3DPtr asset3D, const std::string& assetName, IOutputStreamFactory* streamFactory, FractionalProgressCallback progress, Spectre::Framework::ICancellationTokenPtr cancellationToken, const std::unordered_map<std::string, std::string>& options)
{
...
void ExporterGLB::Export(const Asset3D& asset3d, std::shared_ptr<const glTF::IStreamWriter> streamWriter, const std::string& assetName, const GLTFExportOptions& options, Spectre::Framework::ICancellationTokenPtr cancellationToken)
{
