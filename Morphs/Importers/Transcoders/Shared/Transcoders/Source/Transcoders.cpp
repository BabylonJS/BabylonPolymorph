...
namespace Transcoder
{
        ...
        Spectre::Utils::TelemetryTraceLoggerFactoryFunctionType traceLoggerFactory)
    {
        ...
        //convert any SpectreException to Transcoder
        catch (const Spectre::Utils::SpectreInvalidArgException& ex)
        {
           telemetryHelper.SendImportAbortTelemetry(ex.m_message, bytesRead);
           throw TranscoderInvalidArgException(ex.m_message);
        }
        catch (const Spectre::Utils::SpectreFailException& ex)
        {
            telemetryHelper.SendImportAbortTelemetry(ex.m_message, bytesRead);
            throw TranscoderInvalidDataException(ex.m_message);
        }
        catch (const Spectre::Utils::SpectreNotImplException& ex)
        {
            telemetryHelper.SendImportAbortTelemetry(ex.m_message, bytesRead);
            throw TranscoderNotImplException(ex.m_message);
        }
        catch (const Spectre::Framework::CancelledException& ex)
        {
            telemetryHelper.SendImportAbortTelemetry(ex.what(), bytesRead);
            throw;
        }
        catch (const Spectre::Utils::SpectreException& ex)
        {
           telemetryHelper.SendImportAbortTelemetry(ex.m_message, bytesRead);
        ...
        Spectre::Utils::TelemetryTraceLoggerFactoryFunctionType traceLoggerFactory)
    {
        ...
        try
        {
            ...
            transcoder.ExportFunction(asset3D, Spectre::Utils::GetPathFileName(exportAssetName), outputStreamFactory, progress, cancellationToken, options);
    ...
    {
        return SPECTRE_PACKAGE_VERSION;
    }*/
