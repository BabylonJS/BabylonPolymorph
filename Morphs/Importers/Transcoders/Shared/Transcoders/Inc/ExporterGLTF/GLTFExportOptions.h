...
namespace Spectre
{
    namespace Transcoder
    {
        ...
        public:
            ...
            {
                return Spectre::Transcoder::ParseOptions<GLTFExportOptions>(options);
            }
            ...
            void SetTranscodingMode(const std::string& value)
            {
                ...
                else { throw Utils::SpectreException("Unrecognized value for 'Mode': " + value); }
            }
            ...
            void SetTextureCompression(const std::string& value)
            {
                ...
                else { throw Utils::SpectreException("Unrecognized value for 'TextureCompression': " + value); }
            }
