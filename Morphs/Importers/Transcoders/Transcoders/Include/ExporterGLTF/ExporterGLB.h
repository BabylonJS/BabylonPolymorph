...
namespace Babylon
{
    namespace Transcoder
    {
        ...
        {
        public:
            static void ExportStatic(Asset3DPtr asset3D, const std::string& assetName, IOutputStreamFactory* streamFactory, FractionalProgressCallback progress = nullptr, Babylon::Framework::ICancellationTokenPtr cancellationToken = nullptr, const std::unordered_map<std::string, std::string>& options = {});

            static void Export(const Asset3D& asset3d, std::shared_ptr<const Microsoft::glTF::IStreamWriter> streamWriter, const std::string& assetName, const GLTFExportOptions& options = {}, Babylon::Framework::ICancellationTokenPtr cancellationToken = nullptr);
        };
