    ...
    namespace Transcoder
    {
        ...
        */
        ...
        protected:
            ...
            inline std::shared_ptr<Babylon::Transcoder::TextureDescriptor> GetTexture(LineTokensPtr& tokens);
            inline std::shared_ptr<Babylon::Transcoder::TextureDescriptor> GenerateTexture(const std::string& textureName);
            ...
            Babylon::Utils::Math::Color CreateColor(LineTokensPtr& tokens) const;
...
inline std::shared_ptr<Babylon::Transcoder::TextureDescriptor> Babylon::Transcoder::MaterialObjParser::GetTexture(LineTokensPtr& tokens)
{
...
inline std::shared_ptr<Babylon::Transcoder::TextureDescriptor> Babylon::Transcoder::MaterialObjParser::GenerateTexture(const std::string& textureName)
{
