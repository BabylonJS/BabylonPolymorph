...
namespace Babylon
{
    namespace Transcoder
    {
        ...
        public:
            ...
            {
                return Babylon::Transcoder::ParseOptions<GLTFImportOptions>(options);
            }
            ...
            void SetExtractAnimationData(const std::string& value)
            {
                ...
                else { throw Utils::BabylonException("Unrecognized value for 'ExtractAnimationData': " + value); }
            }
            ...
            void SetForceMinecraftBlendMaterialsToMask(const std::string& value)
            {
                ...
                else { throw Utils::BabylonException("Unrecognized value for 'ForceMinecraftBlendMaterialsToMask': " + value); }
            }
