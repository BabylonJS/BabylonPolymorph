...
namespace Babylon
{
    namespace Transcoder
    {
        ...
        public:
            ...
            void Initialize(const std::unordered_map<std::string, std::string>& transcodeOptions, Babylon::Utils::TelemetryTraceLoggerFactoryFunctionType factory);

            void SendImportStartTelemetry();
            void SendImportCompleteTelemetry(const std::shared_ptr<Babylon::Transcoder::Asset3D> asset3DFromImport, const uint64_t streamByteSize);
            ...
            void SendExportCompleteTelemetry(const std::shared_ptr<Babylon::Transcoder::Asset3D> asset3DFromImport);
            void SendExportAbortTelemetry(const std::string exceptionDetails);

        private:
            std::shared_ptr<Babylon::Utils::ITelemetryTraceLogger> m_telemetryLogger;
            ...
            Babylon::Utils::TelemetryTraceLogger::AnimationStats m_animStats;
