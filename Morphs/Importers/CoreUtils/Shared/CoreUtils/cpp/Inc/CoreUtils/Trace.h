...
#ifdef _WIN32
#define Babylon_IN _In_
#define Babylon_IN_Z _In_z_
#define Babylon_PRINTF_FORMAT_STRING _Printf_format_string_
#else // _WIN32
#define Babylon_IN
#define Babylon_IN_Z
#define Babylon_PRINTF_FORMAT_STRING
#endif // _WIN32
...
namespace Trace
{
    ...
    struct LevelSettingsWrapper
    {
        ...
        void Output(Babylon_IN Level level, Babylon_IN_Z Babylon_PRINTF_FORMAT_STRING const char *formatString, ...);
