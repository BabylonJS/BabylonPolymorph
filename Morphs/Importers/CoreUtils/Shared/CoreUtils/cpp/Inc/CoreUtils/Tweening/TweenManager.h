...
namespace Spectre
{
    namespace Utils
    {
        namespace Tweening
        {
            ...
            {
                SpectreUnusedParameter(from);
                SpectreUnusedParameter(to);
                SpectreUnusedParameter(tweenDirection);
            }
            ...
            public:
                    ...
                    Transformation          transformFunction = Transformation())
                {
                    ...
                    {
                        throw SpectreException("Tween options must have either value or property not null");
                    }
