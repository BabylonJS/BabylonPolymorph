...
namespace Spectre
{
    namespace Utils
    {
        ...
        {
            return CreateSharedInputFileStream(Spectre::Utils::StringToWString(filename), mode);
        }
        ...
        {
            return CreateSharedOutputFileStream(Spectre::Utils::StringToWString(filename), mode);
        }
        ...
        {
            return CreateUniqueInputFileStream(Spectre::Utils::StringToWString(filename), mode);
        }
        ...
        {
            return CreateUniqueOutputFileStream(Spectre::Utils::StringToWString(filename), mode);
        }
        ...
        inline std::unique_ptr<uint8_t[]> ReadStreamIntoUniquePtr(std::istream& stream, size_t& length)
        {
            ...
            {
                throw SpectreException("Failed to read the entire stream");
            }
