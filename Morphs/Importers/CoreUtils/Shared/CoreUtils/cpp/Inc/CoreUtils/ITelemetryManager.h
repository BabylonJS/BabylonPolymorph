...
/**
* Function signature for the BabylonOnTelemetryEventHandler callback.
*
...
*/
typedef void(BABYLON_SDK_CALL *BabylonOnTelemetryEventHandler)(const char* eventName, const char* jsonData);
...
namespace Babylon
{
    namespace Utils
    {
        ...
        typedef std::function<void BABYLON_SDK_CALL (const std::string&, const std::map<std::string, std::string>&, const std::map<std::string, float>&)> OnTelemetryEventHandler;
        typedef std::function<void BABYLON_SDK_CALL (const std::string&, const std::string&)> OnTelemetryEventWithJsonHandler;
        ...
        */
        ...
        {
        public:
            static bool BABYLON_SDK_CALL Initialize(ITelemetryManager* instance);
