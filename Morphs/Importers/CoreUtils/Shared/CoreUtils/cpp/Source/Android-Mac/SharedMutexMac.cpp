...
namespace Babylon
{
    namespace Utils
    {
            ...
            : m_pImpl(std::make_unique<impl>())
        {
            ...
            {
                case ENOMEM:
                    throw Utils::BabylonException("pthread::impl out of memory");
                case EAGAIN:
                    throw Utils::BabylonException("pthread::impl resource unavailable, try again");
                case EPERM:
                    throw Utils::BabylonException("pthread::impl operation not permitted");
                default:
                    break;
            }
        }
        ...
        void SharedMutex::lock()
        {
            ...
            {
                case EDEADLK:
                    throw Utils::BabylonException("pthread::lock deadlock situation detected");
                case EINVAL:
                    throw Utils::BabylonException("pthread::lock given invalid rwlock");
                default:
                    break;
            }
        }
        ...
        bool SharedMutex::try_lock()
        {
            ...
            switch (ret)
            {
                case EBUSY:
                    return false;
                case EINVAL:
                    throw Utils::BabylonException("pthread::try_lock given invalid rwlock");
                default:
                    break;
            }
            return true;
        ...
        void SharedMutex::unlock()
        {
            ...
            if (ret == EINVAL)
            {
                throw Utils::BabylonException("pthread::unlock given invalid rwlock");
            }
        ...
        void SharedMutex::lock_shared()
        {
            ...
            {
                case EDEADLK:
                    throw Utils::BabylonException("pthread::lock_shared deadlock situation detected");
                case EINVAL:
                    throw Utils::BabylonException("pthread::lock_shared given invalid rwlock");
                default:
                    break;
            }
        }
        ...
        bool SharedMutex::try_lock_shared()
        {
            ...
            switch (ret)
            {
                ...
                case EAGAIN:
                    return false;
                case EINVAL:
                    throw Utils::BabylonException("pthread::try_lock_shared given invalid rwlock");
                default:
                    break;
            }
            return true;
