...
namespace glTF
{
    ...
    void SPECTRESDK_CALL OverrideLegacyGLTFMaterial(Microsoft::glTF::Material& material, LegacyMode mode)
    {
        ...
        {
            throw Spectre::Utils::SpectreException(GetMissingExtensionMessage(Microsoft::glTF::KHR::Materials::PBRSPECULARGLOSSINESS_NAME));
        }
    ...
    std::set<std::string> SPECTRESDK_CALL GetJoints(const Microsoft::glTF::Document& document)
    {
    ...
    AnimationMetadata::eType SPECTRESDK_CALL AnimationMetadata::GetType(const Microsoft::glTF::Document& gltfDocument, const Microsoft::glTF::Animation& animation)
    {
        auto skeletalJointNodeIds = Spectre::Utils::glTF::GetJoints(gltfDocument);
    ...
    AnimationMetadata::eSupport SPECTRESDK_CALL AnimationMetadata::GetSupport(const Microsoft::glTF::Document& gltfDocument, const Microsoft::glTF::Animation& animation)
    {
    ...
    Spectre::Utils::Math::Matrix GetTextureTransformMatrix(const Microsoft::glTF::KHR::TextureInfos::TextureTransform& textureTransform)
    {
        auto translation = Spectre::Utils::Math::Matrix::CreateTranslation(textureTransform.offset.x, textureTransform.offset.y, 0.0f);
        auto rotation = Spectre::Utils::Math::Matrix::CreateRotationZ(-textureTransform.rotation);
        auto scale = Spectre::Utils::Math::Matrix::CreateScale(textureTransform.scale.x, textureTransform.scale.y, 1.0f);
        Spectre::Utils::Math::Matrix transform = scale * rotation * translation;
        return transform;
    }

    bool TryGetTextureTransform(const Spectre::Utils::Math::Matrix& matrix, Microsoft::glTF::TextureInfo& textureInfo)
    {
        if (matrix != Spectre::Utils::Math::Matrix::Identity)
        {
