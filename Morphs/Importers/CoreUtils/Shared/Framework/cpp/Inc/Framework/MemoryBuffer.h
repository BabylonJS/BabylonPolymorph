...
public:
    ...
    {
        SpectreAssertExpr(align == 1 || align == 2 || align == 4, "MemoryBuffer::Write - Alignement must be 1, 2 or 4");
    ...
    {
        SpectreAssertExpr(atOffset < m_buffer.size(), "MemoryBuffer: Invalid Offset for GetBuffer");
