        ...
        */
        ...
        struct FrameBigEndian : FrameUncompressed
        {
            ...
            inline const T* GetItemByIndex(uint32_t idx) const
            {
                if (idx >= GetNumItems())
                {
                    throw Babylon::Utils::BabylonException("Frame::GetItemByIndex - Invalid index specified.");
                }
                ...
                {
                    throw Babylon::Utils::BabylonException("Frame::GetItemByIndex - Object outside bounds of frame. Bad data.");
                }
        ...
        struct FrameLittleEndian : FrameUncompressed
        {
            ...
            inline const T* GetItemByIndex(uint32_t idx) const
            {
                if (idx >= GetNumItems())
                {
                    throw Utils::BabylonException("Frame::GetItemByIndex - Invalid index specified.");
                }
                ...
                if (offset + sizeof(T) > GetSizeInBytes())
                {
                    throw Utils::BabylonException("Frame::GetItemByIndex - Object outside bounds of frame. Bad data.");
                }
