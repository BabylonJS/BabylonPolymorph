...
namespace Spectre
{
    namespace Framework
    {
        ...
        {
            kAlbedo = 0,   // Could be Diffuse+Alpha       or BaseColor+Alpha    depending on the value of m_spectreRenderingMode
            kEmissive = 1,
            kWorkflow = 2, // Could be Specular+Glossiness or Metallic+Roughness depending on the value of m_spectreRenderingMode
            kNormal = 3,
            kDepth = 4,
            kOcclusion = 5,
            kDetail = 6,
