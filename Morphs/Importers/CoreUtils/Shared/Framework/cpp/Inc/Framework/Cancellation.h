 ...
 * has been cancelled.
 *
 * This is a slightly modified version of Cancellation.h from the Spectre::Utils
...
public:
    ...
    */
     ...
     *         the slave using ClearCancelledCallback
     */
    virtual int SetCancelledCallback(std::function<void SPECTRESDK_CALL (void)> cancelledCallback) = 0;
 ...
 */
ICancellationTokenPtr SPECTRESDK_CALL MakeCancellationToken();
...
* \return A new cancellation token
*/
ICancellationTokenPtr SPECTRESDK_CALL MakeNullCancellationToken();
