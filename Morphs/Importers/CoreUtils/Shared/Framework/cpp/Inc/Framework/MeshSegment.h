        ...
        */
        ...
        struct SkeletonSegmentLittleEndian : SkeletonSegment
        {
            ...
            struct JointLittleEndian: Joint
            {
                ...
                inline Spectre::Utils::Math::Matrix GetInverseBindMatrix() const    { return Spectre::Utils::Math::Matrix(InverseBindMatrix); }
                inline Spectre::Utils::Math::Matrix GetTransform() const            { return Spectre::Utils::Math::Matrix(Transform); }
            }
            JointData[];
        };
