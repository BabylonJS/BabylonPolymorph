...
namespace Babylon
{
    namespace Framework
    {
        ...
        public:
            ...
            {
                BabylonUnusedParameter(atOffset);
                return nullptr;
            }
            ...
            virtual uint32_t WriteDataRaw(_In_reads_(sizeInBytes) const void* data, uint32_t sizeInBytes, uint32_t align)
            {
                ...
                BabylonUnusedParameter(sizeInBytes);
                BabylonUnusedParameter(align);
                return 0;
            }
            ...
            {
                BabylonUnusedParameter(numBytes);
            }

            virtual uint32_t OffsetOf(const void* ptr) const
            {
                BabylonUnusedParameter(ptr);
                return 0;
            }
