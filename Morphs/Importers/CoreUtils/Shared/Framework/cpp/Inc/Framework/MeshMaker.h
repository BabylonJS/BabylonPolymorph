...
namespace Babylon
{
    namespace Framework
    {
        ...
        typedef std::function<void BABYLON_SDK_CALL (MeshMaker* pMesh)> ProcessMeshCallback;
        typedef std::function<void BABYLON_SDK_CALL (MaterialMaker* pMesh)> ProcessMaterialCallback;
        typedef std::function<void BABYLON_SDK_CALL (TextureMaker* pMesh)> ProcessTextureCallback;
        typedef std::function<void BABYLON_SDK_CALL (LightMaker*)> ProcessLightCallback;
        typedef std::function<void BABYLON_SDK_CALL (Frame*, std::string const& metadataJSON)> OnFrameCallback;
        typedef std::function<void BABYLON_SDK_CALL (AnimationMaker* pAnim)> ProcessAnimationCallback;
        typedef std::function<void BABYLON_SDK_CALL (SkeletonMaker* pAnim)> ProcessSkeletonCallback;
        ...
        */
        class MeshMaker : Babylon::Utils::InstanceCounter<MeshMaker>
        {
        ...
        */
        class MaterialMaker : Babylon::Utils::InstanceCounter<MaterialMaker>
        {
            friend class DataMaker;
        public:
            ...
            inline void SetBabylonRenderingMode(Framework::MaterialDefinition::BabylonRenderingMode mode) { m_BabylonRenderingMode = mode; }
            inline void SetBabylonRenderingOptions(Framework::MaterialDefinition::BabylonRenderingOptions options) { m_BabylonRenderingOptions = options; }
            inline void AppendBabylonRenderingOption(Framework::MaterialDefinition::BabylonRenderingOption option) { m_BabylonRenderingOptions |= option; }
            inline Framework::MaterialDefinition::BabylonRenderingMode GetBabylonRenderingMode() const { return m_BabylonRenderingMode; }
        ...
        protected:
            ...
            Framework::MaterialDefinition::BabylonRenderingMode m_BabylonRenderingMode = Framework::MaterialDefinition::BabylonRenderingMode::Default;
            Framework::MaterialDefinition::BabylonRenderingOptions m_BabylonRenderingOptions = 0;
        };

        /*
        * Class used to create textures ready for serialization into the common object format
        */
        class TextureMaker : Babylon::Utils::InstanceCounter<TextureMaker>
        {
            friend class DataMaker;
        public:
        ...
        {
            BabylonAssertExpr(m_lockedVertexData.m_positionData != nullptr, "MeshMaker::SetPostion - no position data");
        ...
        {
            BabylonAssertExpr(m_lockedVertexData.m_indexData != nullptr, "MeshMaker::SetIndices - no index data");
        ...
        {
            BabylonAssertExpr(m_lockedVertexData.m_normalData != nullptr, "MeshMaker::SetNormal - no normal data");
        ...
        {
            BabylonAssertExpr(vertexIndex < m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetPostion - invalid vertex");
            BabylonAssertExpr(m_lockedVertexData.m_positionData != nullptr, "MeshMaker::SetPostion - no position data");
        ...
        {
            BabylonAssertExpr(pPositions != nullptr, "MeshMaker::SetPositions - invalid (null) pPositions");
            BabylonAssertExpr(numPositions == m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetPositions - invalid position count");
            BabylonAssertExpr(m_lockedVertexData.m_positionData != nullptr, "MeshMaker::SetPositions - no position data");
        ...
        {
            BabylonAssertExpr(vertexIndex < m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetNormal - invalid vertex");
            BabylonAssertExpr(m_lockedVertexData.m_normalData != nullptr, "MeshMaker::SetNormal - no normal data");
        ...
        {
            BabylonAssertExpr(pNormals != nullptr, "MeshMaker::SetPositions - invalid (null) pNormals");
            BabylonAssertExpr(numNormals == m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetNormals - invalid normal count");
            BabylonAssertExpr(m_lockedVertexData.m_normalData != nullptr, "MeshMaker::SetNormals - no normal data");
        ...
        {
            BabylonAssertExpr(vertexIndex < m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetTangent - invalid vertex");
            BabylonAssertExpr(m_lockedVertexData.m_tangentData != nullptr, "MeshMaker::SetTangent - no tangent data");
        ...
        {
            BabylonAssertExpr(vertexIndex < m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetColor - invalid vertex");
            BabylonAssertExpr(m_lockedVertexData.m_colorData != nullptr, "MeshMaker::SetColor - no color data");
        ...
        {
            BabylonAssertExpr(vertexIndex < m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetUV0 - invalid vertex");
            BabylonAssertExpr(m_lockedVertexData.m_uvData[0] != nullptr, "MeshMaker::SetUV0 - no normal data");
        ...
        {
            BabylonAssertExpr(vertexIndex < m_lockedVertexData.m_numVerticesLocked, "MeshMaker::SetUV1 - invalid vertex");
            BabylonAssertExpr(m_lockedVertexData.m_uvData[1] != nullptr, "MeshMaker::SetUV1 - no normal data");
        ...
        {
            BabylonAssertExpr(indices != nullptr, "MeshMaker::SetPositions - invalid (null) indices");
            auto size = 0;
            ...
            BabylonAssertExpr(numIndices == m_lockedVertexData.m_numIndicesLocked, "MeshMaker::SetIndices - invalid index count");
            BabylonAssertExpr(m_lockedVertexData.m_indexData != nullptr, "MeshMaker::SetIndices - no index data");
