...
namespace Spectre
{
    ...
    namespace Framework
    {
        ...
        */
        class GeometryUtils
        {
            typedef std::function<void SPECTRESDK_CALL (std::shared_ptr<Vector3> const&, void*)> NormalsCompletionCallback;
            typedef std::function<void SPECTRESDK_CALL (std::shared_ptr<Vector4> const&, void*)> TangentsCompletionCallback;
            typedef std::function<void SPECTRESDK_CALL (std::shared_ptr<Vector4> const&, std::shared_ptr<Vector3> const&, void*)> NormTangCompletionCallback;
