...
#   include <cll/CorrelationVector.h>
    ...
    int Babylon::Utils::CanvasCll::m_cllCount = 0;

#endif // ENABLE_MACCLL_LIBRARY

Babylon::Utils::CanvasCll::CanvasCll()
{
#if ENABLE_MACCLL_LIBRARY
    if (m_cllCount == 0)
    {
...
void Babylon::Utils::CanvasCll::IncrementCorrelationVector()
{
#if ENABLE_MACCLL_LIBRARY
...
void Babylon::Utils::CanvasCll::Log(std::string eventName, const char* eventData)
{
#if ENABLE_MACCLL_LIBRARY
