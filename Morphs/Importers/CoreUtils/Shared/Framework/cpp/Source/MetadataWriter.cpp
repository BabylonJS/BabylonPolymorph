    ...
    namespace Framework
    {
        namespace V1
        {
            ...
            void MetadataWriter::BeginMetadata(uint32_t id, const char* name)
            {
                ...
                {
                    throw Utils::BabylonFailException("MetadataWriter::BeginMetadata: You must call BeginFrame first");
                }
                if (id == 0)
                {
                    throw Utils::BabylonInvalidArgException("MetadataWriter::BeginMetadata:Invalid itemID of 0 specified");
                }
                if (m_currID != 0)
                {
                    throw Utils::BabylonInvalidArgException("MetadataWriter::BeginMetadata: You must call EndMetadata first");
                }
            ...
            void MetadataWriter::EndMetadata()
            {
                if (m_outputBuffer == nullptr)
                {
                    throw Utils::BabylonFailException("MetadataWriter::EndMetadata: NULL output buffer");
                }
