...
namespace Spectre
{
    namespace Utils
    {
        ...
        class TelemetryTraceLoggerAndroid : public ITelemetryTraceLogger
        {
        public:
            TelemetryTraceLoggerAndroid() {};
            ~TelemetryTraceLoggerAndroid() {};

            const std::shared_ptr<TelemTraceLoggerAttributes> GetAttributes() override { return nullptr; }

            void SetCorrelationVectorGUID(TelemetryTraceLoggerCorrelationVectorId) override { }
