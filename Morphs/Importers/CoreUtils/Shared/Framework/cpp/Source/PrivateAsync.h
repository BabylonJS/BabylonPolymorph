...
public: // IAsyncActionWithProgress
    ...
    virtual SpectreAsyncStatus GetStatus() const override;
...
public:
    ...
    Spectre::Framework::ICancellationTokenPtr GetCancellationToken() const;
...
private:
    ...
    Spectre::Framework::ICancellationTokenPtr m_cancellationToken;

    std::string        m_message;
    std::exception_ptr m_exception;
    SpectreAsyncStatus  m_status;
