...
TelemetryTraceDualLogger::TelemetryTraceDualLogger(std::shared_ptr<ITelemetryTraceLogger> loggerA, std::shared_ptr<ITelemetryTraceLogger> loggerB)
    : m_loggerA(loggerA),
      m_loggerB(loggerB)
{
    SpectreAssertExpr(loggerA, "TelemetryTraceDualLogger instantiated with null loggerA.");
    SpectreAssertExpr(loggerB, "TelemetryTraceDualLogger instantiated with null loggerB.");
}
