...
ConstImage::ConstImage(const ConstImage& other) : m_impl(std::make_shared<ImageImplementation>(*other.m_impl))
{
}
...
const ImageBase::ImageImplementation& ConstImage::CGetImplementation() const
{
    return *m_impl;
}
...
Image::Image(const ConstImage& constImage) : m_impl(std::make_shared<ImageBase::ImageImplementation>(constImage.CGetImplementation()))
{
}
...
ImageBase::ImageImplementation& Image::GetImplementation()
{
    return *m_impl;
}
...
const ImageBase::ImageImplementation& Image::CGetImplementation() const
{
    return *m_impl;
}
