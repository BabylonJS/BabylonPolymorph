...
bool IsCompressed(TextureFormat format)
{
    ...
    {
        throw Spectre::Utils::SpectreException(std::string("CanvasTex::IsCompressed - Invalid texture format ") + std::to_string(std::underlying_type_t<TextureFormat>(format)));
    }
    ...
    const std::function<void(size_t, void*)>& postSaveCallback)
{
    ...
    {
        throw Spectre::Utils::SpectreNotImplException("SaveToMemory - Only PNG or Jpeg.");
    }
    ...
    auto saveCallback = [&outputFormat, &postSaveCallback](const ConstImage& image)
    {
        ...
        {
            throw Spectre::Utils::SpectreException("CanvasTex::SaveToMemory - saveImageToMemory failed");
        }
    };
    ...
    const std::function<void(size_t, void*)>& postSaveCallback)
{
    ...
    {
        throw Spectre::Utils::SpectreException("ImageCount > 1 not supported");
    }
    ...
    const std::wstring& fileName)
{
    if (outputFormat != OutputFormat::Png && outputFormat != OutputFormat::Jpeg)
    {
        throw Spectre::Utils::SpectreNotImplException("SaveToFile - Only PNG or Jpeg.");
    }

    auto saveCallback = [&outputFormat, fileNameUtf8 = Spectre::Utils::WStringToString(fileName)](const ConstImage& image)
    {
        const uint8_t* pixels = image.GetPixels();
        if (pixels == NULL)
        {
        ...
        {
            throw Spectre::Utils::SpectreException("CanvasTex::SaveToFile - saveImageToFile failed");
        }
    };
    ...
    ScratchImage& image)
{
    ...
    {
        throw Spectre::Utils::SpectreException("CanvasTex::Resize - ResizeImage failed");
    }
}
    ...
    ScratchImage& image)
{
    ...
    switch(cImage.GetFormat())
    {
        ...
        default:
            throw Spectre::Utils::SpectreNotImplException(std::string("Decompress is not implemented for format ") + std::to_string(std::underlying_type_t<TextureFormat>(cImage.GetFormat())));
    }
...
void Compress(
    ...
    ScratchImage& cImage)
{
    throw Spectre::Utils::SpectreNotImplException("Compress is not implemented.");
}
...
{
    throw Spectre::Utils::SpectreNotImplException("GenerateMipMaps is not implemented.");
}
