...
#define THROW_IF_FALSE(condition, ...) if (!(condition)) {throw Babylon::Utils::BabylonException(#condition " is false in " __FILE__ " at line " _STRINGIZE(__LINE__) " : " __VA_ARGS__); }
