...
namespace
{
    ...
    void readFromInputStream(png_structrp png_ptr, png_bytep data, png_size_t length)
    {
        ...
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG readFromInputStream failed");
        }
...
namespace CanvasTex
{
    std::vector<uint8_t> ImageProcessorPNG::decompressImage(const void* pSource, size_t inLength) const
    {
        ...
        if (png_ptr == nullptr)
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::decompressImage - Create png_struct failed");
        }
        ...
        if (info_ptr == nullptr)
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::decompressImage - Create png_info struct failed");
        }
        ...
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::decompressImage - Error during Init I/O");
        }
    ...
    std::vector<uint8_t> ImageProcessorPNG::compressImage(const uint8_t* pSource, size_t width, size_t height) const
    {
        ...
        if (png_ptr == nullptr)
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::compressImage - Create png write struct failed");
        }
        // wrapping png_ptr inside a smart pointer
        std::unique_ptr<png_struct, std::function<void(png_structp)>>
            png_smart_ptr(png_ptr, [](png_structp pngptr)
        ...
        if (info_ptr == nullptr)
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::compressImage - Create png info_ptr struct failed");
        }
        // wrapping info_ptr inside a smart pointer
        std::unique_ptr<png_info, std::function<void(png_infop)>>
            info_ptr_smart(info_ptr, [&png_ptr](png_infop infoptr)
        ...
        if (setjmp(png_jmpbuf(png_ptr)))
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::compressImage - Error during Init I/O");
        }
    ...
    MetadataInfo ImageProcessorPNG::getImageMetadata(const void* pSource, size_t inLength) const
    {
        ...
        if (png_ptr == nullptr)
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::getImageMetadata - Create png_struct failed");
        }
        // wrapping png_ptr inside a smart pointer
        std::unique_ptr<png_struct, std::function< void(png_structp)>>
            png_smart_ptr(png_ptr, [](png_structp pngptr)
        ...
        if (info_ptr == nullptr)
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::getImageMetadata - Create png_info struct failed");
        }
        // wrapping info_ptr inside a smart pointer
        std::unique_ptr<png_info, std::function<void(png_infop)>>
            info_ptr_smart(info_ptr, [&png_ptr](png_infop infoptr)
        ...
        if (setjmp(png_jmpbuf(png_ptr)))
        {
            throw Babylon::Utils::BabylonFailException("ImageProcessorPNG::getImageMetadata - Error during Init I/O");
        }
