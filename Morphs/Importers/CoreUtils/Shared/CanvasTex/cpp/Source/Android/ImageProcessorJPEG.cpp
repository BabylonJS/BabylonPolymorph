...
namespace CanvasTex
{
    std::vector<uint8_t> ImageProcessorJPEG::decompressImage(const void* pSource, size_t inLength) const
    {
        ...
        {
            throw Babylon::Utils::BabylonException("ImageProcessorJPEG::decompressImage - Cannot initiate tjInitDecompress");
        }
        ...
        if (result != 0)
        {
            throw Babylon::Utils::BabylonException("ImageProcessorJPEG::decompressImage - Cannot read header info");
        }
        ...
        if (result != 0)
        {
            throw Babylon::Utils::BabylonException("ImageProcessorJPEG::decompressImage - Cannot read jpeg data");
        }
    ...
    std::vector<uint8_t> ImageProcessorJPEG::compressImage(const uint8_t* pSource, size_t width, size_t height) const
    {
        ...
        {
            throw Babylon::Utils::BabylonException("ImageProcessorJPEG::compressImage - Cannot initiate tjInitCompress");
        }
        ...
        if (result != 0)
        {
            throw Babylon::Utils::BabylonException("ImageProcessorJPEG::compressImage - Cannot compress to jpeg");
        }
    ...
    MetadataInfo ImageProcessorJPEG::getImageMetadata(const void* pSource, size_t inLength) const
    {
        ...
        {
            throw Babylon::Utils::BabylonException("ImageProcessorJPEG::getImageMetadata - Cannot initiate tjInitDecompress");
        }
        ...
        if (result != 0)
        {
            throw Babylon::Utils::BabylonException("ImageProcessorJPEG::getImageMetadata - Cannot read header info");
        }
