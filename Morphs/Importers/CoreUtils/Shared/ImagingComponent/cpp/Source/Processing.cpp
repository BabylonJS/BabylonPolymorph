...
// Grey
const uint8_t defaultTexture[Babylon::ImagingV2::ImagingComponent::kDefaultTextureSize] =
{
    ...
    for (size_t v = 0; v < image.GetHeight(); v++)
    {
        for (size_t u = 0; u < image.GetWidth(); u++)
        {
            ...
            */
            ...
            Babylon::Utils::Math::Vector3 N(static_cast<float>(-Gx), static_cast<float>(-Gy), 255.0f * scale);
            N.Normalize();
    ...
    uint8_t& imageFlags)
{
    ...
    {
        imageFlags |= Babylon::Framework::TextureSegment::EFlag::kFlag_TextureHasActiveAlpha;
    }

    if (alphaContent == EImageFileAlphaContent::kAlpha)
    {
        imageFlags |= Babylon::Framework::TextureSegment::EFlag::kFlag_AlphaValid;
    }
}
    ...
    Context& contextOut)
{
    ...
    {
        throw Utils::BabylonException("No images are available in the file.");
    }
    ...
    Context& context)
{
        ...
        textureCompression == TextureCompressionType::BC7 )
    {
        ...
        Framework::TextureSegment::EFormat textureFormat = Babylon::Framework::TextureSegment::EFormat::kBC3_UNORM;
        switch (textureCompression)
        {
        case BC3:
        {
            compressionFormat = CanvasTex::TextureFormat::Bc3Unorm;
            textureFormat = Babylon::Framework::TextureSegment::EFormat::kBC3_UNORM;
            break;
        }
        case BC5:
        {
            compressionFormat = CanvasTex::TextureFormat::Bc5Unorm;
            textureFormat = Babylon::Framework::TextureSegment::EFormat::kBC5_UNORM;
            break;
        }
        case BC7:
        {
            compressionFormat = CanvasTex::TextureFormat::Bc7Unorm;
            textureFormat = Babylon::Framework::TextureSegment::EFormat::kBC7_UNORM;
            break;
        }
        }
        ...
        CanvasTex::SaveToMemory(
            ...
            [&](size_t size, void* ptr)
            {
                void* destinationBuffer = writer->AddTextureEncoded(
                    ...
                    Babylon::Framework::TextureSegment::EFormat::kPNG,
                    context.flags
                );
    ...
    {
        throw Utils::BabylonException("Unsupported texture compression type");
    }
}
    ...
    const Framework::TextureProcessingOptions& options)
{
    ...
    if (options.LayerType == Babylon::Framework::TextureMaterialLayer::kNormal)
    {
    ...
    {
        throw Utils::BabylonException("ImagingComponent::ProcessLODs:Insufficient Writers");
    }
    ...
    const Framework::TextureProcessingOptions& options)
{
    if (writers.empty())
    {
        throw Utils::BabylonException("ProcessRAWLODs: No writers provided");
    }
    ...
    else
    {
        ...
        case Framework::TextureSegment::EFormat::kFormatBGRA32:
            ...
            break;
        default:
            throw Babylon::Utils::BabylonException("Unknown format");
        }
...
void EncodeBGRAForAllLODs(
    ...
    const Framework::TextureProcessingOptions& options)
{
    BabylonUnusedParameter(textureName);
    BabylonUnusedParameter(texturePath);

    if (writers.empty())
    {
        throw Utils::BabylonException("ProcessLODs: No writers provided");
    }
...
{
    BabylonAssert(imageFormat == CanvasTex::TextureFormat::B8g8r8a8Unorm ||
        imageFormat == CanvasTex::TextureFormat::R8g8b8a8Unorm);
