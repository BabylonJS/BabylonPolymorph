    ...
    Framework::TextureSegment::EFormat dstFormat)
{
    ...
    case Framework::TextureSegment::EFormat::kBC7_UNORM:
        ...
        break;
    default:
        throw Babylon::Utils::BabylonException("Unsupported format for DDS");
    }
...
std::vector<uint8_t> EncodeAsPNG256(
    ...
    const std::wstring& fileName)
{
    BabylonUnusedParameter(save);
    BabylonUnusedParameter(fileName);
    CanvasTex::Image img;
    CanvasTex::ScratchImage result;
...
std::vector<uint8_t> EncodeToMemory(
    ...
    bool useGPU)
{
    BabylonAssert(dstFormat != Framework::TextureSegment::EFormat::kPNG &&
...
Framework::TextureSegment::EFormat ToTextureSegmentFormat(TextureFormat format)
{
    ...
    default:
        throw Utils::BabylonException("Cannot convert TextureFormat to TextureSegment::EFormat - unknown TextureFormat");
            }
        }
