...
namespace Spectre
{
    namespace Transcoder
    {
        ...
        public:
            ...
            explicit BoundingBox(const std::vector<Spectre::Utils::Math::Vector3>& positions);
            ...
            inline void Update(std::vector<Spectre::Utils::Math::Vector3> const& positions);
            inline void Update(Spectre::Utils::Math::Vector3 const& position);
            ...
            void Transform(Spectre::Utils::Math::Matrix transform);
...
inline bool Spectre::Transcoder::BoundingBox::operator== (const Spectre::Transcoder::BoundingBox& other) const
{
    return m_minima == other.m_minima && m_maxima == other.m_maxima;
}

inline void Spectre::Transcoder::BoundingBox::Update(std::vector<Spectre::Utils::Math::Vector3> const& positions)
{
...
inline void Spectre::Transcoder::BoundingBox::Update(Spectre::Utils::Math::Vector3 const& position)
{
...
inline void Spectre::Transcoder::BoundingBox::Update(Spectre::Transcoder::BoundingBox const& boundingBox)
{
...
inline void Spectre::Transcoder::BoundingBox::Set(std::array<float, 3> center, std::array<float, 3> extents)
{
...
inline std::array<float, 3> Spectre::Transcoder::BoundingBox::GetCenter() const
{
...
inline std::array<float, 3> Spectre::Transcoder::BoundingBox::GetExtents() const
{
...
inline float Spectre::Transcoder::BoundingBox::GetScale() const
{
    if (!m_isInitialised)
    {
        return 0.;
...
inline void Spectre::Transcoder::BoundingBox::Validate()
{
    for (int i = 0; i < 3; ++i)
    {
...
inline void Spectre::Transcoder::BoundingBox::Recenter(std::array<float, 3> newCenter)
{
    auto extents = GetExtents();
    Set(newCenter, extents);
}

inline void Spectre::Transcoder::BoundingBox::RecenterToOrigin()
{
    std::array<float, 3> origin{ {0, 0, 0} };
    Recenter(origin);
}

inline void Spectre::Transcoder::BoundingBox::Rescale(float scale)
{
    auto extents = GetExtents();
    for (int i = 0; i < 3; ++i)
    {
...
inline void Spectre::Transcoder::BoundingBox::Normalise()
{
    auto scale = GetScale();
    Rescale(scale);
}
...
************************************************************************************************************/
inline bool Equal(const Spectre::Transcoder::BoundingBox& a, const Spectre::Transcoder::BoundingBox& b)
{
