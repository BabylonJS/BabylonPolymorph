...
namespace Spectre
{
    namespace Transcoder
    {
        ...
        public:
            SceneNode();
            SceneNode(const Spectre::Utils::Math::Matrix& transform, const BoundingBox& boundingBox);

            SceneNode(const SceneNode&) = delete;
            std::shared_ptr<SceneNode> Clone() const;

            void SetTransform(const Spectre::Utils::Math::Matrix& transform) { m_transform = transform; }
            const Spectre::Utils::Math::Matrix& GetTransform() const { return m_transform; }
            ...
            std::shared_ptr<SceneNode> CreateChildNode(const Spectre::Utils::Math::Matrix& transform, const BoundingBox& boundingBox);
            ...
            // Bounding Box
            inline void SetBoundingBoxAndTransform(const BoundingBox& boundingBox, const Spectre::Utils::Math::Matrix& transform);
            void CalculateBoundingBox();
            virtual BoundingBox CalcTopDownBounds(const Spectre::Utils::Math::Matrix&) const;
        ...
        protected:
            ...
            Spectre::Utils::Math::Matrix m_transform;
...
inline void Spectre::Transcoder::SceneNode::SetBoundingBoxAndTransform(const BoundingBox& boundingBox, const Spectre::Utils::Math::Matrix& transform)
{
    m_boundingBox = boundingBox;
    m_transform = transform;
}

inline std::shared_ptr<Spectre::Transcoder::SceneNode> Spectre::Transcoder::SceneNode::CreateChildNode(
    const Spectre::Utils::Math::Matrix& transform,
...
inline size_t Spectre::Transcoder::SceneNode::TotalCount(std::function<size_t(Spectre::Transcoder::SceneNode const*)> countFn) const
{
