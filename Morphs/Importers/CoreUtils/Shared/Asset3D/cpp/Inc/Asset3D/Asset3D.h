...
namespace Spectre
{
    namespace Transcoder
    {
        ...
        public:
            ...
            virtual BoundingBox CalcTopDownBounds(const Spectre::Utils::Math::Matrix& transform) const override;
            ...
            ModelMetadata SPECTRESDK_CALL GetMetadata() const
            {
