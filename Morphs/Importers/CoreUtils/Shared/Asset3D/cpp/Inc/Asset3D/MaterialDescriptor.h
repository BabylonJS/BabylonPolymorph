...
namespace Spectre
{
    namespace Transcoder
    {
        ...
        using LayerType = Spectre::Framework::TextureMaterialLayer;

        using RenderingMode = Framework::MaterialDefinition::SpectreRenderingMode;
        using RenderingOption = Framework::MaterialDefinition::SpectreRenderingOption;
        using RenderingOptions = Framework::MaterialDefinition::SpectreRenderingOptions;
        ...
        {
        public:
            using LayerInfo = Spectre::Transcoder::MaterialLayer;
        ...
        private:
            ...
            float m_alphaCutoff = 0.5f; // Applies when renderingMode is SpectreRenderingMode::Mask
        };
    }
}
