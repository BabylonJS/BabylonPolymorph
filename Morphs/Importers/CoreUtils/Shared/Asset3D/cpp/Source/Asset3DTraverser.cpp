...
void Spectre::Transcoder::Asset3DTraverser::Traverse(IAsset3DProcessor& processor, Asset3D& asset3d)
{
...
void Spectre::Transcoder::Asset3DTraverser::Traverse(IAsset3DProcessor& processor, SceneNode& sceneNode)
{
...
void Spectre::Transcoder::Asset3DTraverser::Traverse(IAsset3DProcessor& processor, SceneNode& sceneNode, Mesh& mesh)
{
...
size_t Spectre::Transcoder::Asset3DTraverser::GetDepth() const
{
    return m_depth;
}