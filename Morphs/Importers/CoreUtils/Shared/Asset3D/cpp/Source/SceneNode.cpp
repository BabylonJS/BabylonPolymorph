...
SceneNode::SceneNode(const Spectre::Utils::Math::Matrix& transform, const BoundingBox& boundingBox)
    : ITraversableWithName(), m_transform(transform), m_boundingBox(boundingBox)
{
}

SceneNode::SceneNode()
    : SceneNode(Spectre::Utils::Math::Matrix::Identity, BoundingBox::Zero)
{
}
...
BoundingBox SceneNode::CalcTopDownBounds(const Spectre::Utils::Math::Matrix& transform) const
{
    BoundingBox box;
